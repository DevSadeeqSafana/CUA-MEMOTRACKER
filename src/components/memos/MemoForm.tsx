        ...
        <form className="max-w-5xl mx-auto pb-20 font-sans space-y-4">
            ...
            {isBudgetModalOpen && (
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
                    <div className="bg-white rounded-[2rem] border border-slate-100 shadow-2xl w-full max-w-4xl max-h-[85vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
                        {/* Modal Header */}
                        <div className="px-8 py-6 border-b border-slate-100 flex items-center justify-between sticky top-0 bg-white z-10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[9px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">Configure itemized financial expenses</p>
                                </div>
                            </div>
                            <button
                                type="button"
                        ...
                        <div className="p-8 space-y-6 flex-1 overflow-y-auto bg-slate-50/50">
                            ...
                            <div className="bg-white border border-slate-200 p-6 rounded-2xl space-y-4 shadow-sm">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div className="space-y-1.5">
                                        <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Fiscal Year</label>
                                        <div className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs font-bold text-slate-600 flex items-center gap-2">
                                            <Check size={12} className="text-emerald-500" />
                                            {currentYear?.name || 'Loading...'}
                                        </div>
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs font-bold focus:border-emerald-500 outline-none appearance-none transition-all"
                                        >
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-1.5 bg-emerald-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-sm"
                                    >
                                        + Add Row
                                    </button>
                                </div>
                                ...
                                {fields.map((field, index) => (
                                    <div key={field.id} className="bg-white border border-slate-200 p-5 rounded-2xl space-y-4 relative group shadow-sm">
                                        {fields.length > 1 && (
                                            <button
                                                type="button"
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                                            ...
                                            <div className="md:col-span-5 space-y-1.5">
                                                ...
                                                <div className="w-full bg-emerald-50 border border-emerald-100 rounded-xl px-4 py-2.5 text-xs font-black text-emerald-700 flex items-center">
                                                    {((watch(`budget_items.${index}.quantity`) || 0) * (watch(`budget_items.${index}.amount`) || 0)).toLocaleString(undefined, { minimumFractionDigits: 2 })}
                                                </div>
                                            </div>
                                            <div className="md:col-span-12 space-y-1.5">
                                                <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Attachment (optional)</label>
                                                <div className="flex items-center gap-3">
                                                    <input
                                                        type="file"
                                                    ...
                                                    <label
                                                        ...
                                                        className={cn(
                                                            'flex items-center gap-2 px-4 py-1.5 border rounded-xl text-[10px] font-bold uppercase tracking-widest cursor-pointer transition-all',
                                                    ...
                                                    {watch(`budget_items.${index}.file`) && (
                                                        <button type="button" onClick={() => setValue(`budget_items.${index}.file`, null)} className="p-1.5 text-red-400 hover:bg-red-50 rounded-lg transition-colors">
                                                            <X size={12} />
                                                        </button>
                                                    )}
                                                </div>
                        ...
                        <div className="px-8 py-5 border-t border-slate-100 flex items-center justify-between sticky bottom-0 bg-white z-10">
                            <div>
                                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest block">Requisition Total</span>
                            ...
                            <button
                                type="button"
                                onClick={() => setIsBudgetModalOpen(false)}
                                className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-black uppercase tracking-widest transition-all shadow-lg shadow-emerald-600/20"
                            >
                                Done
                            </button>
                        </div>
